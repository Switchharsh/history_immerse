...
## What has been spent so far: $0.00
...
Every character you have seen in this app was generated by the offline mock provider.
...
Measured with the shipped price table:

| | per scene | scenes within $20 |
|---|---|---|
| 30-turn scene, character model, no caching | $0.216 | **92** |
| same, with context caching | $0.139 | **143** |
| TTS for a full scene (~9k characters) | $0.144 | — |

Speech roughly doubles the cost of a scene. That is why `PARLEY_TTS` defaults to off.
